...
PRODUCT_COPY_FILES += \
    ...
    vendor/cm/prebuilt/V4A/lib/soundfx/libfmas.so:system/lib/soundfx/libfmas.so \
    vendor/cm/prebuilt/V4A/lib/soundfx/libldnhncr.so:system/lib/soundfx/libldnhncr.so \
    vendor/cm/prebuilt/V4A/lib/soundfx/libqcomvoiceprocessing.so:system/lib/soundfx/libqcomvoiceprocessing.so \
